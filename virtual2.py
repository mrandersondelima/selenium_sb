...
class ChromeAuto():
    ...
    def clica_horario_jogo(self, horario_jogo):
        ...
        try:
            self.graphic_chrome.execute_script("var botao = document.querySelector(\"button[data-aut='button-x-close']\"); if (botao) { botao.click(); }")
        except:
            print('Erro ao tentar fechar banner')

        try:
            self.graphic_chrome.execute_script("var botao_fechar = document.querySelector('.ui-icon.theme-ex.ng-star-inserted'); if (botao_fechar) { botao_fechar.click(); }")
        except Exception as e:
            print('Erro ao tentar fechar banner')
    ...
    async def analisa(self):
        ...
        while True:
            ...
            try:
                ...
                for horario_jogo in horarios_proximos_jogos:
                    ...
                    if hora_do_jogo + timedelta(minutes=1) < now:
                        continue                    
