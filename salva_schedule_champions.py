    ...
    def salva_schedules(self):
        while True:
            ...
            try:
                ...
                cur.execute(f"insert into jogos_champions values ('{horario}', '{time_casa}', '{time_fora}', '{odd_empate}', '{odd_casa}', '{odd_fora}')")
                conn.commit()
                conn.close()
                sleep(10)
            except Exception as e:                
