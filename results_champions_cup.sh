...
BASEURL="https://gvc.live.inspiredvss.co.uk/live/soccer3euroleague2023/stream_5/"

curl -s $BASEURL$(curl -s $BASEURL/soccer3euroleague2023.m3u8 2>/dev/null|tail -n 1) -o $TMPFILE.ts; ffmpeg -i $TMPFILE.ts $TMPFILE.png 1>/dev/null 2>&1
