...
BASEURL="https://gvc.live.inspiredvss.co.uk/live/soccer3spanish/stream_5/"

curl -s $BASEURL$(curl -s $BASEURL/soccer3spanish.m3u8 2>/dev/null|tail -n 1) -o $TMPFILE.ts; ffmpeg -i $TMPFILE.ts $TMPFILE.png 1>/dev/null 2>&1
